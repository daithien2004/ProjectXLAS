...
def Xac_Dinh_It_Nhat_5pt():
	st.title("Xác định ít nhất 5 phần tử")
...
def Main():
	try:
		...
		st.session_state["Net"] = cv2.dnn.readNet("./pages/Source/NhanDienTraiCay/trai_cay.onnx")
